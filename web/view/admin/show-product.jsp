                                    ...
                                    <c:forEach items="${productlist}" var="product">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-success" data-toggle="tooltip" data-placement="top"  title="${product.name}"><a href="${pageContext.request.contextPath}/admin/product/edit?id=${product.id}">Sửa</a></button>
