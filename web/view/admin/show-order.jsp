                                ...
                                <tbody>
                                    <c:forEach items="${order}" var="order">
                                        <tr>
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${order.status == NULL || order.status == 'Chưa thanh toán'}"> 
                                            ...
                                            <td>
                                                <c:choose>
                                                    <c:when test="${order.status == 'Đã hủy'}"> 
                                                        ...
                                                        <button class="btn btn-info" data-toggle="tooltip" data-placement="top"  title="${order.id}"><a href="${pageContext.request.contextPath}/admin/order/edit?id=${order.id}">Xem thông tin</a></button>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <button class="btn btn-danger" data-toggle="tooltip" data-placement="top"  title="${order.id}"><a href="${pageContext.request.contextPath}/admin/order/delete?id=${order.id}">Xóa</a></button>
