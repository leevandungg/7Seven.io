                        ...
                        <div class="col-md-5 no-padding">                
                            <div class="aa-promo-left">
                                <div class="aa-promo-banner">                    
                                    <img src="${url}/images/section1.jpg" alt="img">                    
                    ...
                    <div class="aa-product-area">
                        <div class="aa-product-inner">
                            ...
                            <ul class="nav nav-tabs aa-products-tab">
                                ...
                                <li><a href="#phukhien" data-toggle="tab">Phụ kiện</a></li>
                            </ul>
                            <!-- Tab panes -->
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade in active" id="iphone">
                                    <ul class="aa-product-catg">
                                        ...
                                        <c:forEach items="${product_gameconsole}" var="product" end="7">
                                            <li>
                                ...
                                <div class="tab-pane fade" id="diagame">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${product_cds}" var="product" end="7">
                                            <li>
                                                <c:forEach items="${product_sellings}" var="i">
                                                    <c:if test="${product.id == i.id}">
                                ...
                                <div class="tab-pane fade" id="phukien">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${product_others}" var="product" end="7">
                                            <li>
                                                <c:forEach items="${product_sellings}" var="i">
                                                    <c:if test="${product.id == i.id}">
                                                        <span class="aa-product-selling">Hot</span> 
                                ...
                                <div class="tab-pane fade" id="gaming">
                                    <ul class="aa-product-catg">
                                        <!-- start single product item -->
                                        <c:forEach items="${product_gaming}" var="product" end="7">
                                            <li>
                                                <c:forEach items="${product_sellings}" var="i">
                                                    <c:if test="${product.id == i.id}">
                                                        <span class="aa-product-selling">Hot</span> 
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="aa-latest-blog-area">
                    ...
                    <div class="row">
                        <!-- single latest blog -->
                        <c:forEach items="${boardnewlist}" var="boardnew" end="3">
