            ...
            <div class="col-md-12">
                <div class="aa-product-details-area">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                                <div class="aa-product-view-content">
                                    ...
                                    <p class="aa-product-detail-info">${reviewQuantity} đánh giá | ${detail_product.sold} đã bán | ${detail_product.inventory} tồn kho</p>
                    ...
                    <div class="aa-product-related-item">
                        <h3 style="color : rgba(39, 123, 140, 1)">SẢN PHẨM LIÊN QUAN</h3>
